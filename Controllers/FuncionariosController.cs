...
namespace infnetMVC.Controllers
{
    ...
    public class FuncionariosController : Controller
    {
        ...
        {
            var infnetDbContexto = _context.Funcionario.Include(f => f.Departamento);
            return View(await infnetDbContexto.ToListAsync());
        }
        ...
        // GET: Funcionarios/FindByName
        [HttpGet]
        public async Task<IActionResult> FindingByName(string? nome)
        {
            ...
            return View("FindByName", funcionario);
